                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="payment_status" id="payment_status" class="form-control">
                                    ...
                                    <option value="installment">{{ __('translate.Installment') }}</option>
                                ...
                                <table class="table table-hover table-bordered table-md">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="payment in payments">
                                            <td>@{{payment.date}}</td>
                                            <td>@{{payment.Ref}}</td>
                                            <td>@{{formatNumber(payment.montant,2)}} {{$currency}} </td>
                                            <td>
...
<script>
  ...
  Vue.component('validation-observer', VeeValidate.ValidationObserver);
    ...
    New_Payment(payment_status , id) {
     ...
     get_data_create(id) {
      axios
        ...
        .then(response => {
            this.Get_Installments(id);
            this.payment.montant   = response.data.due;
            // this.payment.montant   = this.installment_next;
            this.Sale_id           = id;
    ...
    //----------------------------------------- Get Payments  -------------------------------\\
    Get_Payments(id) {
        axios.get("/sale/sales/payments/" + id)
        .then(response => {
