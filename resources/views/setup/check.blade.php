...
<div class="row mt-3 p-5" >
    <div class="col-12">   
    @if (! $allValuesAreTrue)
     <p class="alert alert-danger">{{ __('translate.Your_server_doesnt_meet_the_following_requirements') }}</p> 
    @endif
        <ul class="list-group">
    ...
    @if ($allValuesAreTrue)
        <div class="offset-6 col-6 col-md-6">
            <a href="/setup/step-1" id="next"  class="btn btn-outline-danger mt-3 float-md-right" >{{ __('translate.Next_Step') }} <i class="fa fa-angle-right"></i></a>
        </div>
    @endif
</div>
