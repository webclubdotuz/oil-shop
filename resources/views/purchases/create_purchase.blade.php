        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <!-- currency_rate -->
              <div class="col-md-4">
                <validation-provider name="currency_rate" rules="required" v-slot="validationContext">
                  <div class="form-group">
                    <label for="currency_rate">{{ __('translate.Rate') }}</label>
                    ...
                    <input type="number"
                      ...
                      id="currency_rate"
                      v-model="purchase.currency_rate" step="any">
      ...
      if (this.verifiedForm()) {
        ...
        axios
          .post("/purchase/purchases", {
            ...
            currency_rate: this.purchase.currency_rate,
          })
          .then(response => {
